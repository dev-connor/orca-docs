...
Drag a worktree's tab to the right or bottom edge of a pane to split. You can watch all three agents at once.
...
Commit and push directly from Orca. The other two worktrees can be deleted with one click; their branches go with them.

## That's it

This flow — add → worktree → agent → split → diff → ship — is the whole of Orca.
